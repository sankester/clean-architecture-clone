import { makeSignUpValidation } from '@framework/server/factories/validations/account/makeSignUpValidation';
import { mockSignupRequest } from '../../../../../adapter/mock/mock-account';
